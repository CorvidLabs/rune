...
📖 جديد هنا؟ ابدأ بـ **[دليل البدء](getting_started.ar.md)**.
...
- 📖 **[دليل البدء](getting_started.ar.md)** — أوضاع المخرجات، واستخدام `rune run`، والمُهَل، والمُحلِّلات مع مخرجات أوامر حقيقية.
- 📖 **[دليل الجلسات الدائمة](sessions.ar.md)** — `rune session`: جلسات PTY مُسمّاة تتجاوز عمرَ استدعاء واحد، و"الإرسال والانتظار حتى الهدوء" لقيادة واجهة سطر أوامر وكيل من وكيل آخر.
- 📖 **[دليل بنية الطرفية الزائفة (PTY)](pty_architecture.ar.md)** — كيف تعمل الطرفيات الزائفة، والقراءة غير الحاجبة للتدفّقات، وتنقية ANSI، واكتشاف المُحِثّات، وتنفيذ النصوص، والتمرير الحيّ ثنائي الاتجاه في `rune watch`، من الداخل في Ruby.
- 📖 **[دليل الإصدار](../releasing.md)** — مزامنة الإصدارات، والتحقّق، والمنشأ، والوسم، ونشر الحزمة.
